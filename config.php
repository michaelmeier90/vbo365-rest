<?php
$host = '10.50.30.150'; /* Veeam Backup for Microsoft Office 365 server (hostname or IP) */
$port = '4443'; /* RESTful API service port (default: 4443) */
$title = 'e-novinfo - VBO Portal'; /* Custom title for the portal to be displayed in the browser title */
